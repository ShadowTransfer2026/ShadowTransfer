#!/bin/bash
# FILENAME: oglanet_sib_newmod.sh
#
# SLURM job script for OGLANet+SIB with diagnostic-motivated modules.
# Extends oglanet_sib.sh with CACR, CE-AURC, and TENT support.
...
# ─────────────────────────────────────────────────────────────────────────────
echo "============================================="
echo "  OGLANet + SIB + NewMod Training Job"
echo "============================================="
echo "  MODE        : ${MODE}"
...
echo "  OGLA_OUT    : ${OGLANET_OUTPUT_DIR}"
echo "  SIB_FLAGS   : ${SIB_FLAGS}"
echo "  DIAG_FLAGS  : ${DIAG_FLAGS}"
