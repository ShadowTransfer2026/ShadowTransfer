...
RESULTS_DIR="/scratch/gilbreth/mittal53/ShadeMaps/data/oglanet/outputs"
OUTPUT_DIR="/scratch/gilbreth/mittal53/ShadeMaps/data/oglanet/loco_aggregate_results"
