...
LOG_DIR="/scratch/gilbreth/mittal53/ShadeMaps/data/oglanet/loco_eval_logs"
...
do
    ...
    do
        ...
        sbatch --output=${outputfile} \
               --job-name=${name} \
               --export=RESOLUTION=${res},FOLD_ID=${fold_id},BASE_DATA_ROOT=${BASE_DATA_ROOT},OUTPUT_DIR=${OUTPUT_DIR} \
               test_loco.sh
