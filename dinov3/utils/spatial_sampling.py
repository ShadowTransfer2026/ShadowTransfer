...
def select_patches_by_strategy(
    ...
    strategy: str = 'random',
    random_seed: int = 42,
    metadata_dir: str = '/scratch/gilbreth/mittal53/ShadeMaps/data/Final_data_test/metadata/',
    base_data_root: str = '/scratch/gilbreth/mittal53/ShadeMaps/data/Final_data_test/',
    split_ratio: Tuple[float, float] = (0.75, 0.25),
