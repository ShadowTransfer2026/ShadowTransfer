...
# ---- Build DDIB flags from env vars ----
# Each component flag (USE_C1, USE_C2, USE_C3) is passed as 0/1
# Loss weights are passed as individual numeric vars
DDIB_FLAGS=""
if [ "${USE_C1}" == "1" ]; then
...
# ---- Run training ----
if [ "$MODE" == "loco" ]; then
    $PYTHON_BIN -u train_dinov3_ddib.py \
        --mode loco \
