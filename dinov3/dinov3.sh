...
# FILENAME: dinov3.sh
#
# SLURM runner for DINOv3 shadow detection training.
...
# conda activate /anvil/projects/x-cis260282/satmae_cuda12/bin/python
...
# When EVAL_TOLERANT=1 it also selects which metric drives decisions.
BOUNDARY_TOL_FLAG=""
