...
Sources (NCSA Delta defaults):
  Test image roots (baseline predictions):
    /projects/bgpi/smittal5/ShadeMaps/data/Test_img_results/loco/{city}/highres/{arch_lower}/{method}/
    /projects/bgpi/smittal5/ShadeMaps/data/Test_img_results/upper/{city}/highres/{arch_lower}/base/
  ...
  Ground-truth masks:
    /projects/bgpi/smittal5/ShadeMaps/data/Final_data_test/{city}/highres/test/masks/
...
def parse_args():
    ...
    p.add_argument('--base_path', type=str,
                   default='/projects/bgpi/smittal5/ShadeMaps',
