...
# Base paths
CHECKPOINT_BASE="/scratch/gilbreth/mittal53/ShadeMaps/data/mamnet/outputs/"
ANNOTATION_BASE="/scratch/gilbreth/mittal53/ShadeMaps/data/NAIP_Data_Process/Images/"
OUTPUT_BASE="/scratch/gilbreth/mittal53/ShadeMaps/data/NAIP_Data_Process/Prelabels/"
    ...
    do
        ...
        do
            ...
            sbatch \
                --output=${OUTPUT_FILE} \
                --job-name=${JOB_NAME} \
                --export=CHECKPOINT=${CHECKPOINT},IMAGE_DIR=${IMAGE_DIR},OUTPUT_DIR=${SESSION_OUTPUT_DIR},CITY=${city},RESOLUTION=${res},SESSION_NUM=${session_num} \
