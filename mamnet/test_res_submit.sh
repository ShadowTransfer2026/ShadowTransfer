...
LOG_DIR="/scratch/gilbreth/mittal53/ShadeMaps/data/mamnet/res_eval_logs"
    ...
    do
        ...
        do
            ...
            sbatch --output=${outputfile} \
                   --job-name=${name} \
                   --export=SOURCE_RES=${source_res},TARGET_RES=${target_res},CITY=${city},BASE_DATA_ROOT=${BASE_DATA_ROOT},OUTPUT_DIR=${OUTPUT_DIR} \
                   test_res.sh
