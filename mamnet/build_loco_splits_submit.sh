...
do
    ...
    do
        ...
        sbatch --output=${outputfile} \
               --job-name=${name} \
               --export=BASE_DATA_ROOT=${BASE_DATA_ROOT},OUTPUT_ROOT=${OUTPUT_ROOT},FOLD_ID=${fold_id},RESOLUTION=${res},TRANSFER_MODE=${TRANSFER_MODE},N_TRAIN_PER_CITY=${N_TRAIN_PER_CITY},N_VAL_PER_CITY=${N_VAL_PER_CITY},NO_MULTICLASS=${NO_MULTICLASS},SEED=${SEED} \
