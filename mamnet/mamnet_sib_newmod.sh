#!/bin/bash
# FILENAME: mamnet_sib_newmod.sh
#
# SLURM job script for MAMNet+SIB with diagnostic-motivated modules.
# Extends mamnet_sib.sh with CACR, CE-AURC, and TENT support.
...
# ─────────────────────────────────────────────────────────────────────────────
echo "============================================="
echo "  MAMNet + SIB + NewMod Training Job"
echo "============================================="
echo "  MODE        : ${MODE}"
