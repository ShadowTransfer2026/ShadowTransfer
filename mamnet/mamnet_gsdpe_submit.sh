...
do
	res="midres"
    name="gsdpe_mamnet__${city}__${res}"
	...
	sbatch --output=${outputfile} \
		   --job-name=${name} \
		   --export=MODE=single,DATA_ROOT=${data_root},RES=${res},CITY=${city},OUTPUT_DIR=${OUTPUT_DIR},USE_CONTRAST="--use_contrast",EVAL_TOLERANT="--eval_boundary_tolerant" \
		   mamnet_gsdpe.sh
